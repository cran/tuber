...
yt_search <- function (term=NULL, max_results=50, channel_id= NULL, channel_type=NULL, type="video", event_type=NULL, location= NULL, location_radius=NULL, 
	...
	if (any (!is.null(video_caption), !is.null(video_license), !is.null(video_definition), !is.null(video_type), !is.null(video_syndicated)) & type!="video") stop("Specify type as video.")
